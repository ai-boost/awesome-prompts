...
| AutoGPT | 10 | Programming/Writing | 25k | A Super Powerful GPT that's designed to automate your work, including complete an entire project, writing a complete book, etc. Just 1 click, 100 times the response. | [AutoGPT](https://chat.openai.com/g/g-f9mgQiPdC-autogpt) | [prompt](https://github.com/ai-boost/awesome-prompts/blob/main/prompts/AutoGPT.md) (The prompt is urgly and not stable now, let's improve it together!) |
