...
|------|------|----------|-----|------|------| ------ |
| 💻Professional Coder | 2nd  | Programming  | 300k+  | A gpt expert at solving programming problems, automatic programming, one-click project generation | [💻Professional Coder](https://chat.openai.com/g/g-HgZuFuuBK-professional-coder-auto-programming) | [prompt](https://github.com/ai-boost/awesome-gpts-prompts/blob/main/prompts/%F0%9F%92%BBProfessional%20Coder.md) |
| 👌Academic Assistant Pro | 3rd  | Writing  | 300k+  | Professional academic assistant with a professorial touch | [👌Academic Assistant Pro](https://chat.openai.com/g/g-Ej5zYQRIB-academic-assistant-pro) | [prompt](https://github.com/ai-boost/awesome-gpts-prompts/blob/main/prompts/%F0%9F%91%8CAcademic%20Assistant%20Pro.md) |
...
| AutoGPT | Not Ranked | Programming/Writing | 1k | A Super Powerful GPT that's designed to automate your work, including complete an entire project, writing a complete book, etc. Just 1 click, 100 times the response. | [AutoGPT](https://chat.openai.com/g/g-f9mgQiPdC-autogpt) | [prompt](https://github.com/ai-boost/awesome-prompts/blob/main/prompts/AutoGPT.md) (The prompt is urgly and not stable now, I will adjust it and post link here when ready!) |
...
|------|-----------|--------------|------|
| Auto Literature Review 🌟 | Academic | A literature review expert that can search papers and write literature review automatically.  | [Auto Literature Review Link](https://chat.openai.com/g/g-lfY2IC1TZ-auto-literature-review)    |
...
| 🌈 Paper Interpreter Pro | Academic | Automatically structure and decode academic papers with ease🌟 - simply upload a PDF or paste a paper URL! 📄🔍 | [Paper Interpreter Pro Link](https://chat.openai.com/g/g-faWqzDEcE-paper-interpreter-pro) |
...
| ⭐ PDF Translator (Academic Version) | Academic | An advanced 🚀 PDF translator for researchers & students, seamlessly translating academic papers 📑 into multiple languages 🌐, ensuring accurate interpretation for global knowledge exchange 🌟. | [PDF Translator Link](https://chat.openai.com/g/g-4u33YVMfB-pdf-translator-academic-version) |
| AutoGPT | Programming/Writing | A Super Powerful GPT that's designed to automate your work, including complete an entire project, writing a complete book, etc. Just 1 click, 100 times the response.  | [AutoGPT Link](https://chat.openai.com/g/g-f9mgQiPdC-autogpt)   |
